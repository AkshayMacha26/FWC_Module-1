...
\subsection*{1970/1}
Let \( M \) be a point on the side \( AB \) of \( \Delta ABC \). Let \( r_1, r_2 \), and \( r \) be the radii of the inscribed circles of triangles \( AMC \), \( BMC \), and \( ABC \), respectively. Let \( q_1, q_2 \), and \( q \) be the radii of the escribed circles of the same triangles that lie in the angle \( ACB \). Prove that
\[
